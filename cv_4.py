...
def add_mp3(intput_video,output_video):
    audio_video = VideoFileClip(intput_video)
    video = VideoFileClip(output_video)
    audio = audio_video.audio
    videoclip2 = video.set_audio(audio)
    name1 = output_video.split('.', 1)[0] + "_out.mp4"
...
def picvideo(path, size):
    ...
    file_path = 'video/birthday.mp4'  # 导出路径
...
add_mp3('video/樱花班.mp4','video/birthday.mp4')
